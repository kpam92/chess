...
class Board
  ...
  def populate_board
    self[[0,1]] = SlidingPiece.new(:white,[0,1],self,:rook)
    self[[0,0]] = SlidingPiece.new(:white,[0,0],self,:rook)
    self[[0,3]] = SteppingPiece.new(:white,[0,3],self,:king)
    self[[7,0]] = SteppingPiece.new(:black,[7,0],self,:king)
  end
  # def populate_board
